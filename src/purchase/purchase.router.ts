...
export class PurchaseRouter extends BaseRouter<PurchaseController, PurchaseMiddlware> {
    constructor() {
    ...
    routes(): void {
        ...
        this.router.post("/create-purchase", (req, res, next) => [this.middleware.purchaseValidator(req, res, next)],
